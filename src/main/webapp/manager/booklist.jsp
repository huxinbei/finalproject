...
<body>
	<div style="padding: 10px; margin-left: 5%;">
			...
			<form action="<%=basePath%>manager/querybook.jsp" method="post">
				<div style="width: 90%; float: left">
					<div style="float: right; padding: 30px; margin-top: 10px;">
						<span style="float: center; font-size: 16px;">图书查询：</span> 
						<select
							name="condition"
		...
		<div style="width: 100%;" align="center">
			<table style="text-align: center; width: 100%; height:100%;font-size: 17px"
				...
				<tr height="50px">
					...
					<td><span class="STYLE1">图书删除</span></td>
					<td><span class="STYLE1">图书修改</span></td>
				</tr>
				<%
					// 获取图书信息集合
				...
				<tr height="50px">
					...
					<td><a href="Deletebookservlet?id=<%=book.getBookid()%>">删除</a></td>
					<td><a
						href="<%=basePath%>manager/updatebook.jsp?id=<%=book.getBookid()%>">修改</a></td>
				</tr>
				<%
					}
					}
		...
		<div >
				<a href="manager/addbook.jsp" target="nav">
					<button type="submit"
						style="width:100px; height: 35px ;margin-left:380px;margin-top:20px">添加图书</button>
				</a>
		</div>
</body>
</html>